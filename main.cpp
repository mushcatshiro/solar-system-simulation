...
constexpr float au2vp = (ViewportWidth) / (MoondDistanceFromEarth * 2.f);  // pix/au
...
CelestialObj moon{"moon", MoondDistanceFromEarth, 0., MoonRadius, MoonMass, sf::Color(201, 201, 201), true};
